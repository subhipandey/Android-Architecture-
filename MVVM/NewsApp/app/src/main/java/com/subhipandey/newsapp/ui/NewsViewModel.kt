...
import com.subhipandey.newsapp.NewsApplication
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String){
        ...
        try {
            if (hasInternetConnection()) {
                ...
                searchNews.postValue(Resource.Error("No inter connection"))
            }
        }catch (t: Throwable){
            when(t) {
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            ...
            breakingNews.postValue(handleBreakingNewsResponse(response))
                ...
                breakingNews.postValue(Resource.Error("No inter connection"))
            }
        }catch (t: Throwable){
            when(t) {
